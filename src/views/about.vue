                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="xe-widget xe-conversations box2 label-info"
                         onclick="window.open('http://liuliansp.github.io/', '_blank')"
                         data-toggle="tooltip"
                         data-placement="bottom"
                         title=""
                         data-original-title="http://liuliansp.github.io/">
                      <div class="xe-comment-entry">
                        ...
                        <div class="xe-comment">
                          <a href="#" class="xe-user-name overflowClip_1">
                            <strong>Liuliansp</strong>
                          </a>
                          <p class="overflowClip_2"> Full-time SRE with an enduring interest in Coding.</p>
                        </div>
                      </div>
                    </div>
                  </div>
